...
## source cmap functions
source("/sc/arion/work/charna02/scripts/rx/cmap_inhouse_functions.r")
...
rmsalts = function(names){
    ...
    salts = c(salts,words[ words %in% c("sodium", "chloride", "bromide", "iodide","potassium", "choride", "magnesium", "calcium", "arionbamine", "arionbramine", "fosfatex", "zinc") ])
    new.salts = c()
